/// BIP-39 English wordlist (2048 words), pinned in-repo.
///
/// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
/// (the canonical BIP-39 English list). Sorted, unique, one word per
/// 11-bit index [0, 2047]. Do not edit by hand; any change here changes
/// every recovery phrase already issued.
const List<String> bip39EnglishWordlist = [
  ...
  'drift', 'drill', 'drink', 'drip', 'drive', 'drop', 'drum', 'dry', 'duck', 'dumb', 'dune',
  ...
  'type', 'typical', 'ugly', 'umbrella', 'unable', 'unaware', 'uncle', 'uncover', 'under',
  'undo', 'unfair', 'unfold', 'unhappy', 'uniform', 'unique', 'unit', 'universe', 'unknown',
