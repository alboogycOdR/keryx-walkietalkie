...
abstract final class SettingsKeys {
  ...
  static const Key messagesSection = Key('settings.section.messages');
  ...
  static const Key preferDirect = Key('settings.prefer-direct');
  static const Key callsign = Key('settings.callsign');
  static const Key showRecoveryPhrase = Key('settings.show-recovery-phrase');
  static const Key restoreFromPhrase = Key('settings.restore-from-phrase');
  static const Key messageRetention = Key('settings.message-retention');
  ...
  static const Key recoveryPhraseView = Key('settings.recovery-phrase-view');
  static const Key recoveryPhraseGate = Key('settings.recovery-phrase-gate');
  static const Key restoreConfirm = Key('settings.restore-confirm');
